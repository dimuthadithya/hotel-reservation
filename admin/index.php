  ...
  <div class="admin-container">
    ...
    <div class="admin-sidebar">
      ...
      <ul class="sidebar-nav">
        ...
        <li class="nav-item">
          <a href="#hotels" data-bs-toggle="tab">
            <i class="fas fa-hotel"></i> Hotels
          </a>
        </li>
        <li class="nav-item">
          <a href="#locations" data-bs-toggle="tab">
            <i class="fas fa-map-marker-alt"></i> Locations
          </a>
        </li>
        <li class="nav-item">
          <a href="#rooms" data-bs-toggle="tab">
            <i class="fas fa-bed"></i> Rooms
          </a>
        </li>
        <li class="nav-item">
          <a href="#amenities" data-bs-toggle="tab">
            <i class="fas fa-concierge-bell"></i> Amenities
          </a>
        </li>
        <li class="nav-item">
          <a href="#bookings" data-bs-toggle="tab">
        ...
        <li class="nav-item">
          <a href="#reports" data-bs-toggle="tab">
